    ...
    <div class="flex flex-col h-full bg-white text-blue-600 shadow-lg rounded-[15px]">
      ...
      <div class="flex-1 overflow-y-auto py-3">
        ...
        <template v-else-if="role === 'professor'">
          ...
          <router-link
            ...
            <span v-if="!collapsed" class="text-blue-600">Evaluation</span>
          </router-link>
          ...
          <router-link
            ...
            <span v-if="!collapsed" class="text-blue-600">Management</span>
          </router-link>
        </template>
        ...
        <template v-else-if="role === 'admin'">
          ...
          <router-link
            ...
            <span v-if="!collapsed" class="text-blue-600">Parameters</span>
          </router-link>
          ...
          <router-link
            ...
            <span v-if="!collapsed" class="text-blue-600">Statistics</span>
          </router-link>
          ...
          <router-link
            ...
            <span v-if="!collapsed" class="text-blue-600">Professor Management</span>
          </router-link>
        </template>
      </div>
      ...
      <div class="mt-auto">
        ...
        <router-link
          ...
          <span v-if="!collapsed" class="text-blue-600">Ask AI</span>
        </router-link>
        ...
        <router-link
          ...
          <span v-if="!collapsed" class="text-blue-600">Settings</span>
        </router-link>
        ...
        <div @click="handleLogout" 
          ...
          <span v-if="!collapsed" class="text-blue-600">Logout</span>
        </div>
      </div>
    </div>
  </div>
